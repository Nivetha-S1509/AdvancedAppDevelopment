...
const UserOrder = lazy(() => import('./pages/Shared/UserOrder'))
        ...
        <Suspense fallback={<Loader />}>
          <Routes>
            ...
            <Route element={<UserLayout />}>
              ...
              <Route path='/user/placeorder' element={<UserOrder />} />
            ...
            <Route element={<AdminLayout />}>
              ...
              <Route path='/admin/recent' element={<AdminMemberships />} />
              <Route path='/admin/upcoming' element={<AdminPayments />} />
              <Route path='/admin/feedback' element={<AdminUsers />} />
              <Route path='/admin/services' element={<AdminMails />} />
              <Route path='/admin/category' element={<AdminSiteconfigs />} />
