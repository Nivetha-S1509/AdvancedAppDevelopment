        ...
        <div className="h-[40vh] w-[50vw] flex flex-row shadow-md shadow-blue-/20">
          <div className="w-1/2 h-full flex flex-col">
            <div className="h-1/6 w-full flex justify-end items-center px-3 gap-3">
              <button
                className="p-2 border-2 border-purple-300/50 hover:border-purple-400 hover:bg-purple-200/40 rounded-full"
                onClick={() => {
                  setEditModel(true);
                }}
              >
                <FiEdit className="text-purple-300" /> {/* Use FiEdit icon */}
              </button>
              <button
                className="p-2 border-2 border-purple-300/50 hover:border-purple-400 hover:bg-purple-200/40 rounded-full"
                onClick={() => {
              ...
              >
                <FiKey className="text-purple-300" /> 
              </button>
            </div>
            <div className="h-3/6 w-full flex justify-center items-center">
              <FiUser className="text-purple-500 text-6xl" /> {/* Bigger size User Icon */}
            </div>
            <div className="h-2/6 w-full flex justify-center items-center">
              <p className="text-3xl font-bold text-purple-500">SEEMA BHARADWAJ</p>
            </div>
          </div>
          <div className="w-1/2 h-full flex justify-center items-center flex-col">
            <div className="h-1/4 w-full flex flex-row border-2 border-purple-200/50">
              <div className="w-1/3 h-full flex items-center justify-start text-purple-300 font-bold bg-purple-200/10 px-4">
                Email
              </div>
            ...
            <div className="h-2/4 w-full flex flex-row border-2 border-purple-200/50">
              <div className="w-1/3 h-full flex items-center justify-start text-purple-300 font-bold bg-blue-200/10 px-4">
                Address
              </div>
              <div className="w-2/3 h-full flex items-center justify-start font-semibold px-4">
                38/110, Nehru street, Adyar, Chennai, India - 648 000
              </div>
            </div>
          </div>
        </div>
      ...
      {editModel && (
        <>
          <div className="h-screen w-screen flex absolute z-50 bg-gray-500/60 justify-center items-center top-0 left-0">
            <div className="h-[45vh] w-[30vw] flex flex-col shadow-md shadow-purple-300/20 bg-white rounded-sm">
              <div className="h-5/6 w-full flex flex-col justify-center items-center p-2 gap-4">
                <input
                  ...
                  id=""
                  placeholder="NAME"
                  value="Seema Baradwaj"
                  className="bg-purple-200/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-purple-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm"
                />
                <input
                  type="email"
                  name=""
                ...
                <input
                  ...
                  placeholder="Phone"
                  value="9897654321"
                  className="bg-blue-200/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-purple-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm"
                />
                <textarea
              ...
              <div className="h-1/6 w-full flex flex-row justify-center items-center">
                <button
                  className="w-1/2 h-full bg-purple-500 font-bold text-white"
                  onClick={() => {
                    setEditModel(false);
                  }}
                >
